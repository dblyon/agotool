...
#echo "now attempting to run script on production server cronjob_monthly_Aquarius_ago_UP.sh @ "$(date +"%Y_%m_%d_%I_%M_%p")" ---"
#ssh dblyon@aquarius.meringlab.org '/home/dblyon/agotool/cronjob_monthly_Aquarius_ago_UP.sh &> /home/dblyon/agotool/data/logs/log_updates.txt & disown'
#check_exit_status
