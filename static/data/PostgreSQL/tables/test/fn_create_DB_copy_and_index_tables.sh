...
psql -h localhost -d agotool -c "COPY functions FROM '/Users/dblyon/Downloads/test/Functions_table.txt';"
psql -h localhost -d agotool -c "COPY function_2_definition FROM '/Users/dblyon/Downloads/test/Function_2_definition_table.txt';"
psql -h localhost -d agotool -c "COPY go_2_slim FROM '/Users/dblyon/Downloads/test/GO_2_Slim_table.txt';"
psql -h localhost -d agotool -c "COPY ogs FROM '/Users/dblyon/Downloads/test/OGs_table.txt';"
psql -h localhost -d agotool -c "COPY og_2_function FROM '/Users/dblyon/Downloads/test/OG_2_Function_table.txt';"
psql -h localhost -d agotool -c "COPY ontologies FROM '/Users/dblyon/Downloads/test/Ontologies_table.txt';"
psql -h localhost -d agotool -c "COPY protein_2_function FROM '/Users/dblyon/Downloads/test/Protein_2_Function_table.txt';"
psql -h localhost -d agotool -c "COPY protein_secondary_2_primary_an FROM '/Users/dblyon/Downloads/test/Protein_Secondary_2_Primary_AN_table.txt';"
psql -h localhost -d agotool -c "COPY protein_2_og FROM '/Users/dblyon/Downloads/test/Protein_2_OG_table.txt';"
