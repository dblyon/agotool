...
class TestUserInput(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls._ui = goretriever.UserInput(user_input_fn)

    def test_get_study_an_frset(self):
        ...
        self.assertEqual(study, self._ui.get_study_an_frset())

    def test_get_population_an_set(self):
        study_fn = home + r'/modules/cpr/goterm/test/study_yeast_acetyl.txt'
        pop_fn =   home + r'/modules/cpr/goterm/test/population_yeast_obsProteome.txt'
        study, pop = find_enrichment.read_geneset(study_fn, pop_fn, compare=False)
        self.assertEqual(pop, self._ui.get_population_an_set())
