...
def plot():
    ...
    dict_per_category, term_2_positionInArr_dict = run.df_2_dict_per_category()
    ...
    return render_template('plot.html', form=Enrichment_Form(),
        ...
        dict_per_category=dict_per_category, sizeref=sizeref, term_2_positionInArr_dict=term_2_positionInArr_dict)
