...
cols_sort_order_comprehensive = [s_value, category, term, hierarchical_level, description, over_under, p_value, FDR, logFDR, effect_size, year, FG_IDs, BG_IDs, FG_count, FG_n, BG_count, BG_n, ratio_in_FG, ratio_in_BG, rank]
    ...
    for category_, group in df.groupby(category):
        for term, value in group[column].iteritems():
            ...
            if value > 0: # to the right.
                ...
                color_bar = ""
            style_temp = {"if": {"column_id": "s value", "filter_query": "{id} = " + term}, "background": "linear-gradient(90deg, {} )".format(color_bar), "paddingBottom": 1, "paddingTop": 1, } # {'if': {'row_index': 'odd'}, 'backgroundColor': table_background_color}, }  # "width": "10em", "height": "80%",
            styles.append(style_temp)
    return styles

# {'if': {'row_index': 'odd'}, 'backgroundColor': table_background_color},
# {'if': {'row_index': 'odd'}, 'backgroundColor': "inherit !important"},
...
data_table_dbl = dash_table.DataTable(
            ...
            style_cell={                 # ensure adequate header width when text is shorter than cell's text
                ...
                "fontSize": "12px",
                #"font-family": "sans-serif,roboto", # roboto,
                "font-family": "sans-serif,roboto,Helvetica Neue,Arial,Noto Sans",
                "text_align": "center",
                "border": "0px",
            },
            style_cell_conditional=
                [{"if": {"column_id": s_value}, "width": "80px",}] # 100
                +
                [{"if": {"column_id": term}, "textAlign": "left", "width": "100px",}] # 120
                +
                [{"if": {"column_id": description}, "textAlign": "left", "width": "300px",}] # 4000
                +
            ...
            style_data={ # overflow cells' content into multiple lines
                ...
                'maxWidth': 0,
                'if': {'row_index': 'odd'}, 'backgroundColor': table_background_color, # + " !important"
            },
...
def highlight_dataTableRows_and_pointsInScatter_on_selectInDataTable(selected_rows, derived_virtual_data, derived_virtual_selected_rows, derived_virtual_selected_row_ids, derived_virtual_indices, derived_virtual_row_ids, active_cell, selected_cells):
    ...
    if selected_rows is not None:
        ...
        # style_data_conditional_extension = [{'backgroundColor': 'transparent'}]
...
# ToDo
# - backgroundColor of "s_value" column
# - Xaxis scroll bar vanish when possible
...
# https://pandas.pydata.org/pandas-docs/stable/user_guide/style.html --> data bar