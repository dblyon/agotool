...
#################################################
### STRING beta REST API specific sort order and columns
### for STRING_beta --> Damian calls on string-gamma or string-beta (http://string-pythongamma.org)
# for original API
cols_sort_order_characterize_foreground_STRING_beta = (FG_count, FG_IDs, ratio_in_FG, term, etype, category, hierarchical_level, description, year)
# all other methods (except for characterize_foreground)
cols_sort_order_STRING_beta = (term, hierarchical_level, p_value, FDR, category, etype, description, FG_count, BG_count, FG_IDs, year)
#################################################

### colnames and sort order for REST API analogous to STRING API
# genome or compare_samples
cols_sort_order_STRING_API_genome_or_compare_samples = ('category', 'term', 'number_of_genes', 'number_of_genes_in_background', 'ncbiTaxonId', 'inputGenes', 'preferredNames', 'p_value', 'fdr', 'description')
# functional_annotation
cols_sort_order_STRING_API_functional_annotation = ('category', 'term', 'number_of_genes', 'ratio_in_set', 'ncbiTaxonId', 'inputGenes', 'preferredNames', 'description')
######################
...
# STRING
colnames_2_rename_dict_STRING_beta = {FG_count: "foreground_count",
                                 BG_count: "background_count",
                                 FG_IDs: "foreground_ids",
                                 ratio_in_FG: "ratio_in_foreground",
                                 FDR: "FDR",
...
# STRING API
colnames_2_rename_dict_STRING_API = {FG_count: "number_of_genes",
                                     BG_count: "number_of_genes_in_background",
                                     FG_IDs: "inputGenes",
                                     p_value: "p_value",
                                     FDR: "fdr",
                                     description: "description",
                                     ratio_in_FG: "ratio_in_set",}
