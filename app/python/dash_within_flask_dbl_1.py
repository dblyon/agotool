...
def init_dashboard(server):
    ...
    row1 = html.Tr([
        html.Td([
            daq.ToggleSwitch(id='toggle_point_labels', value=False, size=30, label='label selected points', labelPosition='bottom', style=dict(color=toggle_button_color, )),
            daq.ToggleSwitch(id='toggle_point_edges', value=False, size=30, label='related terms', labelPosition='bottom', style=dict(color=toggle_button_color, )), html.P(), dbc.Button('reset plot/table', id='button_reset_plot', n_clicks=0, color="secondary", outline=True, className="mr-1", size="sm", style=dict(align_items="center", justify_content="center")), ], style=dict(valign="top nowrap", align_items="center", justify_content="center", ), ),
        html.Td([html.Div(id="scatter_container", children=[]), ], style=dict(align_items="center", justify_content="center")),
    ], )
    dash_app.layout = html.Div(id='general_div', className="container", children=[html.Div(html.Tbody([row1])), html.P(), html.Div(id="second_row", className="dbl", children=[dbc.Row(children=[dbc.Col(width=1), dbc.Col(html.Div(data_table_dbl, ), className="container", ), dbc.Col(width=1), ], justify="center"), ], ),
        html.P(),
    ], )
